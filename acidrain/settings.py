"""
Django settings for acidrain project.
...
SECRET_KEY = 'qv(jq*ta^h7)_824l2ut*l8)ymi&no$t&fl0%7uls3s8jcjf+_'
...
WSGI_APPLICATION = 'acidrain.wsgi.application'
